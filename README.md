...
|---|---|---|---|---|
| Kali Linux | `kali-attacker` | `treyc` | `192.168.50.1` | Attacker and security-testing workstation |
| Ubuntu Server | `ubuntu-server` | `testlab` | `192.168.50.129` | Linux target and monitored server |
| Windows 11 | `Win11-VM` | `testlab` | `192.168.50.128` | Windows target workstation |
